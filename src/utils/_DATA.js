let users = {
  ...
  mtsamis: {
    ...
    name: "Mike Tsamis",
    avatarURL:
      "https://cdn.sanity.io/images/tlr8oxjg/production/c5b56b35fe9d2fe9d78c2fe5df1dda52a75da2b6-360x360.jpg?w=96&q=100&fit=clip&auto=format",
    answers: {
...
export function _saveQuestion(question) {
  return new Promise((resolve, reject) => {
    ...
    setTimeout(() => {
      const userQuestions = users[question.author]?.questions || [];
      users = {
        ...users,
        [question.author]: {
